...
- **Decision (recommended, pending user confirm):** Adopt **gemini-3.5-flash · v3** as ship/dev model — near-equal headline (gap = 1 case + shared hard ceiling) but clearly stronger on issue_type/severity/object_part and best flat average. Next targets: the 3 shared hard cases (007/014/020 — blurry-image handling + damage-not-visible + seal-text/authenticity).
